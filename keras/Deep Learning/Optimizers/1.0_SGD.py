...
plt.xlabel('Epochs')
plt.ylabel("Acurácia")
plt.show() #provavelmente o modelo está sofrendo underfitting pq a acuracia dos dados de treino estavam abaixo dos dados de teste e ambos ainda estavam subindo.
